        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 mb-3">
                    <a href="{{ route('taskse.create') }}" class="btn btn-primary">
                                    ...
                                    @foreach($eventTasks as $task)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('taskse.editTask', $task->id) }}" method="GET" style="display: inline;">
                                                ...
                                                <form action="{{ route('taskse.destroyTask', $task->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('taskse.editTask', $task->id) }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="mb-3">
