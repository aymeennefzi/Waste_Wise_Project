                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12 col-xl-3 d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-primary d-xl-none"type="button"data-bs-toggle="offcanvas"data-bs-target="#offcanvasSidebar">
                            </div>
					...
					<div class="col-xl-9" style="display: flex; flex-wrap: wrap; gap: 10px;">
                        ...
                        <div class="card" style="background-color: #fff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); width: calc(33.33% - 10px); overflow: hidden; transition: transform 0.3s;">
                            <div class="card-header" style="background-color: #121212; color: white; padding: 15px;">
                                <h2 style="font-size: 1.5rem; margin: 0; color: #f8f9fa">{{ $task->task_type }}</h2>
                            </div>

                            <div class="card-content" style="padding: 15px;">
                                <p style="margin-bottom: 10px;"><strong>Event:</strong> {{ $task->event->eventName ?? 'N/A' }}</p>
                                <p style="margin-bottom: 10px;"><strong>Start Time:</strong> {{ $task->start_time }}</p>
                                <p style="margin-bottom: 10px;"><strong>End Time:</strong> {{ $task->end_time }}</p>
                                <p class="description" style="margin-bottom: 10px;"><strong>Description:</strong> {{ \Illuminate\Support\Str::limit($task->description, 100) }}</p>
                                <p style="margin-bottom: 10px;"><strong>Estimated Duration:</strong> {{ $task->estimated_duration }} minutes</p>
                                <p style="margin-bottom: 10px;"><strong>Cost Estimate:</strong> ${{ number_format($task->cost_estimate, 2) }}</p>
                            </div>
